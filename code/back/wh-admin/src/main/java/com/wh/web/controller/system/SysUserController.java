...
import com.wh.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    @GetMapping("/page")
    public TableDataInfo page(SysUser user)
    {
        startPage();
     ...
     * 状态修改
     */
    @PreAuthorize("@ss.hasPermi('system:user:whourConfig')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PostMapping ("/changeConfigStatus")
    public AjaxResult changeConfigStatus(@RequestBody SysUser user)
    {
        userService.checkUserAllowed(user);
        userService.checkUserDataScope(user.getUserId());
        user.setUpdateBy(getUsername());
