...
public class ProjectReactor {
    private static final String GROUP_ID = "com.wh";
    private static final String ARTIFACT_ID = "wh";
    private static final String PACKAGE_NAME = "com.wh";
    private static final String TITLE = "工时管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.wh";
        String artifactIdNew = "wh";
        String packageNameNew = "com.wh";
        String titleNew = "工时管理系统";

        String projectBaseDirNew = "D:\\project\\back\\wh"; // 一键改名后，“新”项目所在的目录
